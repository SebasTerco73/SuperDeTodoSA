...
private void cargarProducto() {
        listaProductos.add(new Producto(1, "Azucar x kg", 600.50, 25, Categoria.COMESTIBLE));
        listaProductos.add(new Producto(2, "Yerba mate x kg", 1000, 21, Categoria.COMESTIBLE));
        listaProductos.add(new Producto(3, "Detergente x l", 800, 11, Categoria.LIMPIEZA));
        listaProductos.add(new Producto(4, "Desodorante x l", 5000, 55, Categoria.PERFUMERIA));
    }
}
